...
import AdminSeminarsConductedTable from "../table/Tables/Admin/AdminSeminarsConductedTable"
import AdminSeminarsAttendedTable from "../table/Tables/Admin/AdminSeminarsAttendedTable"
...
export default function AdminSeminarLayout() {
  return (
    <div className="container mx-auto p-4 space-y-4">
      ...
      <Tabs defaultValue="conducted" className="w-full">
        ...
        <TabsContent value="conducted">
          <Card className="p-4">
            <AdminSeminarsConductedTable/>
          </Card>
        </TabsContent>
        
        <TabsContent value="attended">
          <Card className="p-4">
            <AdminSeminarsAttendedTable/>
          </Card>
        </TabsContent>
