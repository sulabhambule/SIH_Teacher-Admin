...
router.get(
  "/seminar-attended/:teacherId",
  verifyTeacherJWT,
  completeSeminarAttendedPoints
);
router.get(
  "/expert-lectures/:teacherId",
  verifyTeacherJWT,
  completeExpertLecturesPoints
);
...
router.get(
  "/student-guided/:teacherId",
  verifyTeacherJWT,
  completeStudentGuidedPoints
);
router.get(
  "/contribution/:teacherId",
  verifyTeacherJWT,
  completeContributionPoints
);
...
router.get(
  "/ad-seminar-attended/:teacherId",
  verifyAdminJWT,
  completeSeminarAttendedPoints
);
router.get(
  "/ad-expert-lectures/:teacherId",
  verifyAdminJWT,
  completeExpertLecturesPoints
);
...
router.get(
  "/ad-student-guided/:teacherId",
  verifyAdminJWT,
  completeStudentGuidedPoints
);
router.get(
  "/ad-contribution/:teacherId",
  verifyAdminJWT,
  completeContributionPoints
);
